...
<head>
    ...
    <title>Задание 5 - Валидация формы с авторизацией</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="form-card">
        <?php 
        // Вставка формы авторизации/информации о пользователе
        if (!isset($generated_credentials) && !isset($_SESSION['user_id'])) {
            ...
            <form action="" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" value="<?php echo htmlspecialchars($values['email'] ?? ''); ?>"
                           ...
                           <?php echo isset($_SESSION['user_id']) ? 'readonly style="background:#f5f5f5;"' : ''; ?>>
                    <div class="help-text">Формат: name@domain.com<?php echo isset($_SESSION['user_id']) ? ' (Email нельзя изменить после регистрации)' : ''; ?></div>
                </div>
                ...
                <button type="submit" class="submit-btn"><?php echo isset($_SESSION['user_id']) ? 'Обновить данные' : 'Отправить форму'; ?></button>
            </form>
        </div>
    </div>
</body>
